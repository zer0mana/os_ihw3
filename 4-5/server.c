...
void handle_client(int client_fd) {
  ...
  if (is_male) {
    if (hotel.single_rooms > 0) {
      hotel.single_rooms--;
      printf("Мужчина заселяется в одноместный номер. Оставшиеся номера: %d одноместных, %d двухместных\n",
             hotel.single_rooms, available_double_rooms());
    } else if ((double_room_index = occupy_double_room(is_male)) != -1) {
      printf("Мужчина заселяется в двухместный номер #%d. Оставшиеся номера: %d одноместных, %d двухместных\n",
    ...
    if (hotel.single_rooms > 0) {
      hotel.single_rooms--;
      printf("Женщина заселяется в одноместный номер. Оставшиеся номера: %d одноместных, %d двухместных\n",
             hotel.single_rooms, available_double_rooms());
    } else if ((double_room_index = occupy_double_room(is_male)) != -1) {
      printf("Женщина заселяется в двухместный номер #%d. Оставшиеся номера: %d одноместных, %d двухместных\n",
             double_room_index, hotel.single_rooms, available_double_rooms());
    } else {
